;メッセージレイヤの定義
		...
		[position width=1280 height=720 top=0 left=0 ]


		
			[position page=fore frame="fukidasi.PNG" margint=570 marginl=150 marginr=20 marginb=10 vertical=false opacity="180" ]
		

		[ptext name="chara_name_area" layer="message0" color=0x000000 size=26 x=149 y=548 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=1280 height=720 top=0 left=0 ]
